...
export class DefaultSchema1621597683788 implements MigrationInterface {
    name = 'DefaultSchema1621597683788'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "categorie" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "UQ_bfa532987d4bcbe7d99ce731c7d" UNIQUE ("name"), CONSTRAINT "PK_a761331f20634c53bf660312062" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "age" integer NOT NULL, "phone" character varying NOT NULL, "state" character varying NOT NULL, "city" character varying NOT NULL, "occupation" character varying NOT NULL, "description" character varying NOT NULL, "avatar" character varying NOT NULL, "categorie" character varying, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_e82c5ee9fb63c559b09b10ee791" FOREIGN KEY ("categorie") REFERENCES "categorie"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_e82c5ee9fb63c559b09b10ee791"`);
